module.exports = Object.freeze({
  TOKEN: '1436730490:AAE_zdMdil4KM-6wkH4MDZbjr1C8NURArhQ',
  ARIA_SECRET: 'myaria2',
  ...
  GDRIVE_PARENT_DIR_ID: '1DE0evsqG6gsn4cuWcP8djbyrTNo_JzyS',
  OTHER_GDRIVE_DIR_IDS: [], // This is needed if u want to look for files in multiple dirs on list command
  SUDO_USERS: [1131653685],	// Telegram user IDs. These users can use the bot in any chat.
  AUTHORIZED_CHATS: [1131653685],	// Telegram chat IDs. Anyone in these chats can use the bot.
